...
project = u'Cloud Programming for FutureGrid and Azure'
copyright = u'2012, Gregor von Laszewski'
...
latex_documents = [
  ('index', 'CloudProgramming.tex', u'Cloud Programming',
...
man_pages = [
    ('index', 'cloudprogramming', u'Cloud Programming',
...
texinfo_documents = [
  ('index', 'CloudProgramming',
   u'Cloud Programming Documentation',
...
epub_title = u'Cloud Programming'
epub_author = u'Gregor von Laszewski'
epub_publisher = u'Gregor von Laszewski'
epub_copyright = u'2012, Gregor von Laszewski'
